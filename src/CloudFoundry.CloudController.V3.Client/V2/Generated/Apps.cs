...
namespace CloudFoundry.CloudController.V2.Client
{
    ...
    {
        internal AppsEndpoint(CloudFoundryClientV2 client,ISimpleHttpClient simpleHttpClient) : base(simpleHttpClient)
        {
            this.Client = client;
        }
    }
...
namespace CloudFoundry.CloudController.V2.Client.Base
{
    ...
    public abstract class AbstractAppsEndpoint : BaseEndpoint
    {
        ...
        /// </summary>
        protected AbstractAppsEndpoint(ISimpleHttpClient simpleHttpClient):base(simpleHttpClient)
        {
        }
