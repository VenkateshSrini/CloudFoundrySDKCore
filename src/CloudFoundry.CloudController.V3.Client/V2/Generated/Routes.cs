...
namespace CloudFoundry.CloudController.V2.Client
{
    ...
    {
        internal RoutesEndpoint(CloudFoundryClientV2 client, ISimpleHttpClient simpleHttpClient) : base(simpleHttpClient)
        {
            this.Client = client;
        }
    }
...
namespace CloudFoundry.CloudController.V2.Client.Base
{
    ...
    public abstract class AbstractRoutesEndpoint : BaseEndpoint
    {
        ...
        /// </summary>
        protected AbstractRoutesEndpoint(ISimpleHttpClient simpleHttpClient):base(simpleHttpClient)
        {
        }
