...
namespace CloudFoundry.CloudController.V2.Client
{
    ...
    {
        internal AppUsageEventsEndpoint(CloudFoundryClientV2 client, ISimpleHttpClient simpleHttpClient) 
...
namespace CloudFoundry.CloudController.V2.Client.Base
{
    ...
    public abstract class AbstractAppUsageEventsEndpoint : BaseEndpoint
    {
        ...
        /// </summary>
        protected AbstractAppUsageEventsEndpoint(ISimpleHttpClient simpleHttpClient):base(simpleHttpClient)
        {
        }
