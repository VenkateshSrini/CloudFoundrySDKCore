...
namespace CloudFoundry.CloudController.V2.Client
{
    ...
    {
        internal ServiceInstancesEndpoint(CloudFoundryClientV2 client,
...
namespace CloudFoundry.CloudController.V2.Client.Base
{
    ...
    public abstract class AbstractServiceInstancesEndpoint : BaseEndpoint
    {
        ...
        /// </summary>
        protected AbstractServiceInstancesEndpoint(ISimpleHttpClient simpleHttpClient):base(simpleHttpClient)
        {
        }
