...
namespace CloudFoundry.CloudController.V2.Client
{
    ...
    {
        internal BuildpacksEndpoint(CloudFoundryClientV2 client, ISimpleHttpClient simpleHttpClient) : base(simpleHttpClient)
        {
            this.Client = client;
        }
    }
...
namespace CloudFoundry.CloudController.V2.Client.Base
{
    ...
    public abstract class AbstractBuildpacksEndpoint : BaseEndpoint
    {
        ...
        /// </summary>
        protected AbstractBuildpacksEndpoint(ISimpleHttpClient simpleHttpClient):base(simpleHttpClient)
        {
        }
