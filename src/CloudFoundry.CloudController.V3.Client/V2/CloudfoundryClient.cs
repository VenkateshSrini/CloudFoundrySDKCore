namespace CloudFoundry.CloudController.V2.Client
{
    ...
    /// </summary>
    public sealed class CloudFoundryClientV2 : CloudFoundry.CloudController.Common.CloudFoundryClient, IUAA
    {
        ...
        public CloudFoundryClientV2(Uri cloudTarget, CancellationToken cancellationToken)
        ...
        public CloudFoundryClientV2(Uri cloudTarget, CancellationToken cancellationToken, Uri httpProxy)
        ...
        public CloudFoundryClientV2(Uri cloudTarget, CancellationToken cancellationToken, Uri httpProxy, bool skipCertificateValidation) 
        ...
        public CloudFoundryClientV2(Uri cloudTarget, CancellationToken cancellationToken, Uri httpProxy, bool skipCertificateValidation, Uri authorizationUrl)
        ...
        public CloudFoundryClientV2(Uri cloudTarget, CancellationToken cancellationToken, Uri httpProxy, bool skipCertificateValidation, Uri authorizationUrl, bool useStrictStatusCodeChecking)
        ...
        public CloudFoundryClientV2(Uri cloudTarget, CancellationToken cancellationToken, Uri httpProxy, bool skipCertificateValidation, Uri authorizationUrl, bool useStrictStatusCodeChecking, TimeSpan requestTimeout)
        ...
        {
            this.Apps = new AppsEndpoint(this,SimpleHttp);
            this.AppUsageEvents = new AppUsageEventsEndpoint(this, SimpleHttp);
            this.Blobstores = new BlobstoresEndpoint(this, SimpleHttp);
            this.Buildpacks = new BuildpacksEndpoint(this, SimpleHttp);
            this.DomainsDeprecated = new DomainsDeprecatedEndpoint(this, SimpleHttp);
            this.EnvironmentVariableGroups = new EnvironmentVariableGroupsEndpoint(this, SimpleHttp);
            this.Events = new EventsEndpoint(this, SimpleHttp);
            this.FeatureFlags = new FeatureFlagsEndpoint(this, SimpleHttp);
            this.Files = new FilesEndpoint(this, SimpleHttp);
            this.Info = new InfoEndpoint(this, SimpleHttp);
            this.Jobs = new JobsEndpoint(this, SimpleHttp);
            this.OrganizationQuotaDefinitions = new OrganizationQuotaDefinitionsEndpoint(this, SimpleHttp);
            this.Organizations = new OrganizationsEndpoint(this, SimpleHttp);
            this.PrivateDomains = new PrivateDomainsEndpoint(this, SimpleHttp);
            this.ResourceMatch = new ResourceMatchEndpoint(this, SimpleHttp);
            this.Routes = new RoutesEndpoint(this, SimpleHttp);
            this.SecurityGroupRunningDefaults = new SecurityGroupRunningDefaultsEndpoint(this, SimpleHttp);
            this.SecurityGroups = new SecurityGroupsEndpoint(this, SimpleHttp);
            this.SecurityGroupStagingDefaults = new SecurityGroupStagingDefaultsEndpoint(this, SimpleHttp);
            this.ServiceBindings = new ServiceBindingsEndpoint(this, SimpleHttp);
            this.ServiceBrokers = new ServiceBrokersEndpoint(this, SimpleHttp);
            this.ServiceInstances = new ServiceInstancesEndpoint(this, SimpleHttp);
            this.ServiceKeys = new ServiceKeysEndpoint(this, SimpleHttp);
            this.ServicePlans = new ServicePlansEndpoint(this, SimpleHttp);
            this.ServicePlanVisibilities = new ServicePlanVisibilitiesEndpoint(this, SimpleHttp);
            this.Services = new ServicesEndpoint(this, SimpleHttp);
            this.ServiceUsageEvents = new ServiceUsageEventsEndpoint(this, SimpleHttp);
            this.SharedDomains = new SharedDomainsEndpoint(this, SimpleHttp);
            this.SpaceQuotaDefinitions = new SpaceQuotaDefinitionsEndpoint(this, SimpleHttp);
            this.Spaces = new SpacesEndpoint(this, SimpleHttp);
            this.Stacks = new StacksEndpoint(this, SimpleHttp);
            this.UserProvidedServiceInstances = new UserProvidedServiceInstancesEndpoint(this, SimpleHttp);
            this.Users = new UsersEndpoint(this, SimpleHttp);
        }
    }
}